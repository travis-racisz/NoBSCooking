...
var LocalizationContext_1 = require("./LocalizationContext");
...
var LocalizationProvider = /** @class */ (function (_super) {
    ...
    LocalizationProvider.prototype.render = function () {
        return (React.createElement(LocalizationContext_1.LocalizationContext.Provider, { value: this.getLocalizationService() }, React.Children.only(this.props.children)));
    };
    /**
     * @hidden
     */
